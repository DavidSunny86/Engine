...
void main()
{
	...
	float d2 = texelFetch(densityTexture, voxelPosition + edgeSize.xxx + offset.zzy, 0).r;
	...
	float d5 = texelFetch(densityTexture, voxelPosition + edgeSize.xxx + offset.yzz, 0).r;
	float d6 = texelFetch(densityTexture, voxelPosition + edgeSize.xxx + offset.zzz, 0).r;
	float d7 = texelFetch(densityTexture, voxelPosition + edgeSize.xxx + offset.zyz, 0).r;
